   ...
   xmonad $ docks def {
      ...
      -- hooks, layouts
        ...
        logHook            = dynamicLogWithPP xmobarPP
                               ...
                               , ppVisible = xmobarColor "#f2c29b" ""                -- Visible but not current workspace
                               , ppHidden = xmobarColor "#d58546" "" . wrap "*" ""   -- Hidden workspaces in xmobar
                               , ppHiddenNoWindows = xmobarColor "#f2c29b" ""        -- Hidden workspaces (no windows)
                               , ppTitle = xmobarColor "#f2c29b" "" . shorten 60     -- Title of active window in xmobar
